...
export default function Intro() {
  return (
    <div className="my-32 max-w-2xl font-semibold text-4xl">
      <span className="dark:text-apple-white text-apple-black">This is money&rsquo;s final form.</span> <span className="text-apple-gray dark:text-apple-lightgray">All of economic history has led us to Bitcoin. The perfect monetary policy. Impervious to debasement. Accessible to anyone. Controlled by no one. Infinite shelf-life. Lighter than air. Moves at the speed of light.</span>
